...
![image-20230109221652779](D:\Relational-Algebra-Operation-System\doc\assets\image-20230109221652779.png)
...
要进行语法分析，需要构建预测分析表，对于关系代数表达式的分析表推导过程如下。
...
对比两表元组，将表1与表2相同的元组加入结果表内。

###### 并

对比两表元组，将表1元组全部加入结果表内，将表2与表1不同的元组加入结果表内。

###### 差

对比两表元组，将表1与表2不同的元组加入结果表内。
