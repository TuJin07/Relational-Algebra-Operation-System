...
import com.example.operation_system.exception.RelationNotExistsException;
...
public interface ComputingService {
     ...
     * @return 计算后的结果
     */
    RelationVo compute(String expression) throws ComputingException, WrongColumnNameException, IllegalOperationException, RelationNotExistsException;
